...
export const SITE = {
  ...
  /** 홈 <title> 에 붙는 한 줄 설명 */
  tagline: '학교폭력변호사',
  /** 홈 메타 디스크립션 (네이버 웹마스터 권장 80자 이내 — 넘으면 경고·검색결과 잘림) */
  description:
    '교사, 서울시교육청 학교폭력 전담 변호사 출신 전수민 변호사가 직접 상담/수행합니다',
  locale: 'ko_KR',
  lang: 'ko',
} as const;
...
export const VERIFICATION = {
  ...
  /** 네이버 서치어드바이저 소유확인 코드. 사이트를 여러 번 등록했으면 전부 나열하면 됩니다. */
  naver: [
    '2a82453ddd22d9ba34ac3c8c8bdb114ff7654147',
    'f69aaa1f0078e2ae6d043cc2cc6053da4ddfe27e',
  ],
} as const;
